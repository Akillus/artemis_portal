<template>
  <div>
    ...
    >
      <div class="rounded-2xl overflow-hidden" :class="{ 'mb-lg border-base border-gray bg-white': title }">
        <div v-if="title" class="bg-white items-center p-sm flex justify-between border-b-base border-gray">
          ...
          <div class="flex items-center">
            ...
            <help-tooltip title="Hold shift and drag a selection to search in time range" top="-3rem">
              <i class="fas fa-info-circle text-blue text-lg mr-md"></i>
            </help-tooltip>
