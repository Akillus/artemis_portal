    ...
    >
      <div :id="bucketListId" class="relative">
        ...
        >
          <div v-if="bucket.key && String(bucket.key).trim() && !utils.isInvalid(bucket.key)">
            ...
            <div
              ...
              class="filter-item is-active text-md group"
            ...
            >
              ...
              <span class="filter-count group-hover:text-red">
                <i class="fa-times fas align-middle transition-color duration-300 text-sm" />
              </span>

              <span v-if="bucket.doc_count !== undefined" class="filter-count ml-sm">
                {{ bucket.doc_count || 0 }}
              </span>
            </div>
            ...
            >
              ...
              <span v-if="id === 'culturalPeriods' && bucket.doc_count">
                <span class="filter-count mx-xs">Start: {{ bucket.start }}</span>
              </span>

              <span v-if="bucket.doc_count" class="filter-count">
        ...
        <div
          ...
          class="filter-item text-midGray text-md"
        >
          No results found.
        </div>
        ...
        <div
          ...
          class="filter-item text-blue text-md"
          @click="getMore++"
        >
          Get 20 more results..
        </div>
