  ...
  <div class="relative border-base border-gray ariadne-map rounded-2xl overflow-hidden bg-white">
    ...
    >
      <div
        ...
        class="bg-white ease-out duration-200 overflow-hidden border-b-base border-gray"
      >
        <div class="p-sm items-center flex justify-between">
          <span class="text-md">{{ title }}</span>
          <div class="flex overflow-hidden">
            <button v-if="canSearch"
              class="bg-blue-50 px-md py-sm text-center text-sm text-white hover:bg-blue transition-all duration-300 mr-md rounded-xl"
    ...
    >
      <div
        v-if="showMarkerInfo"
        class="bg-white ease-out duration-200 overflow-hidden border-t-base border-gray"
      >
        <div class="max-w-screen-xl mx-auto">
          <div class="map-legend block md:flex md:justify-between items-center text-midGray text-md">
