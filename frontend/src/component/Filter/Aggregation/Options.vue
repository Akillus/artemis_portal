<template>
  ...
  >
    ...
    <input
      ...
      class="filter-toolbar__input text-md outline-none"
    ...
    >
      ...
      <button
        ...
        class="filter-toolbar__button transition-all duration-200 focus:outline-none"
        :class="{ 'is-active': options.sortBy === (sortKey || 'key') }"
      >
      ...
      <button v-if="sortKeyOption"
        ...
        class="filter-toolbar__button transition-all duration-200 focus:outline-none"
        :class="{ 'is-active': options.sortBy === sortKeyOption }"
      >
      ...
      <button
        ...
        class="filter-toolbar__button transition-all duration-200 focus:outline-none"
        :class="{ 'is-active': options.sortBy === 'doc_count' }"
      >
