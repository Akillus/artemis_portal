<template>
    ...
    <div class="relative w-toolbar top-2xl left-0 mb-lg shadow-full z-10">
      ...
      >
        ...
        >
          <div class="map-legend border-t-base border-gray bg-white">
            <div class="map-legend__title px-md pt-md">
              Legend
            </div>
            <ul class="map-legend__list justify-center text-mmd text-black p-md">
