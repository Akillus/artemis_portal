...
<template>
  <div class="filter-accordion">
    <div
      class="filter-accordion__header text-md cursor-pointer select-none flex items-center justify-between transition-all duration-200"
    ...
    >
      ...
      >
        <div class="filter-accordion__title">
          <i
            class="fa-chevron-right fas mr-sm duration-200 filter-accordion__chevron"
